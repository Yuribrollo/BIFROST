...
public class BluetoothManager : MonoBehaviour
{
    ...
    public Transform destination; // Referência ao destino do personagem
    public NavMeshAgent navMeshAgent; // Referência ao NavMeshAgent
    public float bpm; // Armazena a velocidade recebida do Arduino
    ...
    void Start()
    {
        ...
        {
            navMeshAgent.speed = 0; // Inicializa a velocidade como 0
        }
    }

    void Update()
    {
        //bpm = int.Parse(novaData);
        navMeshAgent.speed = bpm;
